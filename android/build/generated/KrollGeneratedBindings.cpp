...
#include "fr.squirrel.pdfview.PdfviewModule.h"
...
namespace titanium {
	namespace bindings {
		...
		class PdfviewBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* PdfviewBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"fr.squirrel.pdfview.PdfviewModule", ::fr::squirrel::pdfview::PdfviewModule::bindProxy, ::fr::squirrel::pdfview::PdfviewModule::dispose},
				{"fr.squirrel.pdfview.ViewProxy", ::fr::squirrel::pdfview::pdfview::ViewProxy::bindProxy, ::fr::squirrel::pdfview::pdfview::ViewProxy::dispose}
			};
